package com.example.Insurance_Management_Platform.Models;

import com.example.Insurance_Management_Platform.Enum.PolicyType;
...
public class InsurancePolicy {
    ...
    //relation between insurance and client policy is many to one relationship
    @ManyToOne
    @JoinColumn
